...
async function generateSession(body) {
  ...
  const instructions = [
    ...
    "Return 20 to 30 challenges total.",
    "Use a balanced mix of formats across multiple choice, German cloze completion, typing German from English, typing English from German, and article-aware vocabulary meaning checks.",
    "Do not repeat the same content plus format combination inside the session.",
...
async function generateDrilldown(body) {
  ...
  const instructions = [
    ...
    "Use varied formats when useful and do not repeat the same content plus format combination inside a topic.",
